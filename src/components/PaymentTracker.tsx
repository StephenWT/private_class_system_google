...
export default function PaymentTracker() {
  ...
  // --- Themed print: reuse app CSS links + theme variables ---
  const printReceipt = async (inv: InvoiceRow) => {
    try {
      ...
      // 3) Build HTML (light custom CSS; let app CSS handle most)
...
.brand{background:var(--p);color:white;padding:20px 24px;border-radius:12px}
.brand .title{font-size:26px;font-weight:800;letter-spacing:.02em}
